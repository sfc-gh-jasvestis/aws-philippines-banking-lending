  ...
  const executiveCockpit = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KPICard title="Loan Portfolio" value={kpiVal('Loan Portfolio', '₱284B')} status="neutral" />
        <KPICard title="NPL Ratio" value={kpiVal('NPL Ratio', '3.2%')} status="warning" />
        <KPICard title="Disbursements (MTD)" value={kpiVal('Disbursements (MTD)', '₱12.4B')} status="neutral" />
        <KPICard title="Borrowers Active" value={kpiVal('Borrowers Active', '1.8M')} status="neutral" />
      </div>
  ...
  const domainTab1 = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <KPICard title="Expected Loss" value={kpiVal('Expected Loss', '₱4.8B')} />
        <KPICard title="Migration to Stage 2" value={kpiVal('Migration to Stage 2', '+2.4%')} />
        <KPICard title="Collection Rate" value={kpiVal('Collection Rate', '94%')} />
      </div>
      <Chart
